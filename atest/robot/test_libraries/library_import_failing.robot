...
Invalid Library
    ...
    ...    traceback=raise ImportError("I'm not really a library!")    level=UNKNOWN
...
Initializing Fails Without Arguments
    ...
    ...    traceback=InitializationFailLibrary.py", line 4, in __init__    level=UNKNOWN
...
Initializing Fails Due To Too Many Arguments
    ...
    ...    Library 'InitializationFailLibrary' expected 0 to 2 arguments, got 3.    level=UNKNOWN

Initializing Fails Due To Invalid Named Argument Usage
    Error in file    4    test_libraries/library_import_failing.robot    6
    ...    Library 'InitializationFailLibrary' got positional argument after named arguments.    level=UNKNOWN
