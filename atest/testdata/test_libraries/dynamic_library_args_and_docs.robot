...
Documentation and Argument Boundaries Work With No Args
    [Documentation]    UNKNOWN Keyword 'classes.ArgDocDynamicLibrary.No Arg' expected 0 arguments, got 1.
    No Arg
    No Arg    1

Documentation and Argument Boundaries Work With Mandatory Args
    [Documentation]    UNKNOWN Keyword 'classes.ArgDocDynamicLibrary.One Arg' expected 1 argument, got 0.
    One Arg    arg
    One Arg

Documentation and Argument Boundaries Work With Default Args
    [Documentation]    UNKNOWN Keyword 'classes.ArgDocDynamicLibrary.One Or Two Args' expected 1 to 2 arguments, got 3.
    One Or Two Args    1
    One Or Two Args    1    2
    One Or Two Args    1    2    3

Default value as tuple
    [Documentation]    UNKNOWN Keyword 'classes.ArgDocDynamicLibrary.Default As Tuple' expected 1 to 3 arguments, got 4.
    Default as tuple    1
