...
*** Test Cases ***
Reload with name
    [Documentation]    UNKNOWN No keyword with name 'bar.added here' found.
...
Reload with instance
    [Documentation]    UNKNOWN No keyword with name 'bar.added another' found.
...
Original name is not usable when import with WITH NAME
    [Documentation]    UNKNOWN No library 'Reloadable' found.
