...
Non-Unique Keywords Without Full Name Fails 2
    [Documentation]    UNKNOWN Multiple keywords with name 'Keyword In Both Libraries' found. \
...
Non-Unique Keywords Without Full Name Fails 3
    [Documentation]    UNKNOWN Multiple keywords with name 'Keyword In All Resources And Libraries' found. \
    ...    Give the full name of the keyword you want to use:
