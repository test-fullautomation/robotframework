...
Implicit Long Alphanumeric Garbage Keyword
    [Documentation]    UNKNOWN    No keyword with name 'fhj329gh9ufhds98f3972hufd9fh839832fh9ud8h8' found.
    fhj329gh9ufhds98f3972hufd9fh839832fh9ud8h8

Explicit Long Alphanumeric Garbage Keyword
    [Documentation]    UNKNOWN    No keyword with name 'fhj329gh9ufhds98.f3972hufd9fh839832fh9ud8h8' found.
    fhj329gh9ufhds98.f3972hufd9fh839832fh9ud8h8

Implicit Special Character Garbage Keyword
    [Documentation]    UNKNOWN    No keyword with name '*&(&^%&%$#%#@###!@!#@$$%#%&^<">:>?:""{+' found.
    *&(&^%&%$#%#@###!@!#@$$%#%&^<">:>?:""{+
...
Implicit Keyword Similar To User Keyword
    [Documentation]    UNKNOWN    No keyword with name 'A Uuser Keyword' found. Did you mean:
    ...    ${INDENT}A User Keyword
    A Uuser Keyword

Wrapped By Run Keyword Implicit Missing
    [Documentation]    UNKNOWN    No keyword with name 'missing keyword' found.
...
Wrapped By Run Keyword Explicit Missing
    [Documentation]    UNKNOWN    No keyword with name 'RecLibrary1.missing keyword' found.
...
Non-similar Embedded User Keyword
    [Documentation]    UNKNOWN    No keyword with name 'Unique misspelled kkw blah' found.
    Unique misspelled kkw blah

Embedded Similar User Keywords
    [Documentation]    UNKNOWN    No keyword with name 'Embbedded User joe Argument password Keyword 3' found.
...
Wrong Library Name
    [Documentation]    UNKNOWN    No keyword with name 'NoSuchLib.Nothing' found.
    NoSuchLib.Nothing
...
Substring of Long Keyword
    [Documentation]    UNKNOWN    No keyword with name 'Really Long Keyword' found.
    Really Long Keyword
...
Just Library Name
    [Documentation]    UNKNOWN    No keyword with name 'RecLibrary1' found.
    RecLibrary1

Leading Period Keyword
    [Documentation]    UNKNOWN    No keyword with name '.Nothing' found.
    .Nothing
...
Underscore
    [Documentation]    UNKNOWN    No keyword with name '_' found.
    _
...
More Non-ASCII
    [Documentation]    UNKNOWN    No keyword with name 'ლ(ಠ益ಠლ)' found.
    ლ(ಠ益ಠლ)
